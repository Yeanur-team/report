...
echo $i" |"$cy"     Bangladesh Virus Squad"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Yeanur Shah  [yeanur-team]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Aeon Yeanur"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.Mathuresh] [MR.Antor] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [Yeanur Team]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 01788014388"$i"             |"
echo $i" |"$pu" Contact Gmail :"$ku" bdvirussquad@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"Yeanur-team"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 01788014388"
echo $ku"Facebook :"$i" aeonyeanur"
sleep 2
echo $pur">> Thanks for Support  <<"
exit
fi
